...
public class Inventory
{
    ...
    public Dictionary<AmmoType, ushort> Ammos { get; set; } = [];
...
public class Advanced
{
    ...
    public Escape Escaping { get; set; } = new();
    ...
    public class Escape
    {
        ...
        public Dictionary<EscapeScenario, RoleTypeId> RoleAfterEscape = [];

        [Description("Custom Role after Escaping with the Scenario.")]
        public Dictionary<EscapeScenario, string> RoleNameAfterEscape = [];
    }
}
...
public class SCP_Specific
{
    ...
    public class _096
    {
        ...
        public List<DoorType> DoorToNotPryOn { get; set; } = [];
    }
...
public class Damager
{
    ...
    public Dictionary<DamageType, ValueSetter> DamageReceivedDict { get; set; } = [];

    [Description("Damage Dictionary that Player Sent/Dealt.")]
    public Dictionary<DamageType, ValueSetter> DamageSentDict { get; set; } = [];
}
...
{
    public string OnDying { get; set; } = string.Empty;
